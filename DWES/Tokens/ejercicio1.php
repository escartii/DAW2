...
// Guardar el token de la sesión en una variable de sesión
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($accion === '') {
        ...
        if (!in_array($accion, $opcionesValidas)) {
            ...
            // Guardar la selección anterior antes de actualizar la información del usuario actual
