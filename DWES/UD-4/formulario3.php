...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        ...
        echo "<strong>Comentario:</strong> " . htmlspecialchars($_GET["comentario"]) . "<br>";
        
        if (isset($_GET["ofertas"])) {
            echo "<strong>Deseo recibir información:</strong> Sí<br>";
        } else {
            echo "<strong>Deseo recibir información:</strong> No<br>";
        }
        
        if (isset($_GET["condiciones"])) {
            echo "<strong>Aceptación de condiciones:</strong> Aceptado<br>";
        } else {
            echo "<strong>Aceptación de condiciones:</strong> No aceptado<br>";
        }
    }
    ?>
</body>
